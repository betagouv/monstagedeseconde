...
Rails.application.configure do
  config.content_security_policy do |policy|
    ...
    policy.frame_src   'https://*.crisp.chat', 'https://chatmd.forge.apps.education.fr', ENV['METABASE_SITE_URL']
    policy.worker_src  :self, :blob, 'https://*.crisp.chat'
    if Rails.env.development?
      policy.frame_src :self, 'http://localhost:3000', 'https://*.crisp.chat', 'https://chatmd.forge.apps.education.fr', ENV['METABASE_SITE_URL']
    end
