...
class ManagePracticalInfosTest < ApplicationSystemTestCase
  ...
  test 'can create PracticalInfos' do
    travel_to Date.new(2024, 1, 1) do
      ...
      sign_in(employer)
      visit new_dashboard_stepper_practical_info_path(organisation_id: organisation.id,
                                                      internship_offer_info_id: internship_offer_info.id, hosting_info_id: hosting_info.id)
