module ThirdPartyTestHelpers
  ...
  def educonnect_userinfo_ineligible_level_stub
    stub_request(:get, ENV["EDUCONNECT_URL"] + "/idp/profile/oidc/userinfo")
      .with(
        headers: {
          "Authorization" => "Bearer token_educonnect",
      ...
      .to_return(status: 200, body: File.read("test/fixtures/files/educonnect_userinfo_ineligible_level.json"), headers: {})
  end
  ...
  def stub_sygne_eleve(ine:, token:, code_uai: "0590121L", code_mef: "10310019110", classe: "3E4",
                       niveau: "2211", nom_famille: "DOE", prenom1: "John", status: 200, body: nil)
    default_body = {
      "ine" => ine,
