  ...
  class WeeklyFramedTest < ActiveSupport::TestCase
    ...
    test '#split_in_two' do
      ...
      assert_changes -> { InternshipOffer.count }, from: 1, to: 2  do
        ...
        assert_equal [SchoolTrack::Seconde.first_week.id], stored_offer.weeks.ids
