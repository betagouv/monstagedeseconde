...
class MultiInternshipAgreementTest < ActiveSupport::TestCase
  ...
  test 'should belong to internship_application' do
    association = MultiInternshipAgreement.reflect_on_association(:internship_application)
    assert_equal :belongs_to, association.macro
  end

  test 'should belong to user with coordinator_id as foreign key' do
    association = MultiInternshipAgreement.reflect_on_association(:coordinator)
    assert_equal :belongs_to, association.macro
    assert_equal "User", association.options[:class_name]
  end

  test 'is invalid without internship_application' do
    multi_internship_agreement = build(:multi_internship_agreement, internship_application_id: nil)
    assert_not multi_internship_agreement.valid?
    assert_includes multi_internship_agreement.errors[:internship_application], "doit être rempli(e)"
  end

  test 'is invalid without user (coordinator_id)' do
    multi_internship_agreement = build(:multi_internship_agreement, coordinator: nil, access_token: "short", student_full_name:'f')
    refute multi_internship_agreement.valid?
    assert_includes multi_internship_agreement.errors[:coordinator], "doit être rempli(e)"
    assert_includes multi_internship_agreement.errors[:access_token], "ne fait pas la bonne longueur (doit comporter 16 caractères)"
  ...
  test 'is invalid without organisation_representative_role' do
    multi_internship_agreement = build(:multi_internship_agreement, organisation_representative_role: nil)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid if organisation_representative_role is too long' do
    multi_internship_agreement = build(:multi_internship_agreement, organisation_representative_role: 'a' * 151)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid without student_address' do
    multi_internship_agreement = build(:multi_internship_agreement, student_address: nil)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid if student_address is too long' do
    multi_internship_agreement = build(:multi_internship_agreement, student_address: 'a' * 171)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid without school_representative_phone' do
    multi_internship_agreement = build(:multi_internship_agreement, school_representative_phone: nil)
    refute multi_internship_agreement.valid?
    assert_includes multi_internship_agreement.errors[:school_representative_phone], "doit être rempli(e)"
  end

  test 'is invalid if school_representative_phone is too long' do
    multi_internship_agreement = build(:multi_internship_agreement, school_representative_phone: '1' * 21)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid if student_full_name is too short or too long' do
    short = build(:multi_internship_agreement, student_full_name: 'abcd')
    long = build(:multi_internship_agreement, student_full_name: 'a' * 101)
    refute short.valid?
    refute long.valid?
  ...
  test 'is invalid without student_legal_representative_email' do
    multi_internship_agreement = build(:multi_internship_agreement, student_legal_representative_email: nil)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid if student_legal_representative_email is too long' do
    multi_internship_agreement = build(:multi_internship_agreement, student_legal_representative_email: 'a' * 101)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid without student_legal_representative_full_name' do
    multi_internship_agreement = build(:multi_internship_agreement, student_legal_representative_full_name: nil)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid if student_legal_representative_full_name is too long' do
    multi_internship_agreement = build(:multi_internship_agreement, student_legal_representative_full_name: 'a' * 101)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid without student_legal_representative_phone' do
    multi_internship_agreement = build(:multi_internship_agreement, student_legal_representative_phone: nil)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid if student_legal_representative_phone is too long' do
    multi_internship_agreement = build(:multi_internship_agreement, student_legal_representative_phone: '1' * 21)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid without school_representative_email' do
    multi_internship_agreement = build(:multi_internship_agreement, school_representative_email: nil)
    refute multi_internship_agreement.valid?
    assert_includes multi_internship_agreement.errors[:school_representative_email], "doit être rempli(e)"
  end

  test 'is invalid if school_representative_email is too long' do
    multi_internship_agreement = build(:multi_internship_agreement, school_representative_email: 'a' * 101)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid without student_birth_date' do
    multi_internship_agreement = build(:multi_internship_agreement, student_birth_date: nil)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid without access_token' do
    multi_internship_agreement = build(:multi_internship_agreement, access_token: nil)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid if access_token is not 16 chars' do
    multi_internship_agreement = build(:multi_internship_agreement, access_token: 'short')
    refute multi_internship_agreement.valid?
    assert_includes multi_internship_agreement.errors[:access_token], "ne fait pas la bonne longueur (doit comporter 16 caractères)"
  end

  test 'is invalid without activity_scope' do
    multi_internship_agreement = build(:multi_internship_agreement, activity_scope: nil)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid if activity_scope is too long' do
    multi_internship_agreement = build(:multi_internship_agreement, activity_scope: 'a' * 1501)
    refute multi_internship_agreement.valid?
  ...
  test 'is invalid if both daily_hours and weekly_hours are blank' do
    multi_internship_agreement = build(:multi_internship_agreement, daily_hours: nil, weekly_hours: nil)
    refute multi_internship_agreement.valid?
  ...
  test 'is valid if daily_hours is present and weekly_hours is blank' do
    multi_internship_agreement = build(:multi_internship_agreement, daily_hours: "09:00-17:00", weekly_hours: nil)
    assert multi_internship_agreement.valid?
  end

  test 'is valid if weekly_hours is present and daily_hours is blank' do
    multi_internship_agreement = build(:multi_internship_agreement, daily_hours: nil, weekly_hours: "35")
    assert multi_internship_agreement.valid?
  end

  test 'has many signatures' do
    association = MultiInternshipAgreement.reflect_on_association(:signatures)
    assert_equal :has_many, association.macro
    assert_equal "destroy", association.options[:dependent].to_s
  end
end
