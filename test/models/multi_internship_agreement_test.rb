...
class MultiInternshipAgreementTest < ActiveSupport::TestCase
  ...
  #   multi_internship_agreement = build(:multi_internship_agreement, organisation_representative_role: 'a' * 151, enforce_school_manager_validations: true)
  #   refute multi_internship_agreement.valid?
  ...
  #   multi_internship_agreement = build(:multi_internship_agreement, school_representative_phone: '1' * 21, enforce_school_manager_validations: true)
  #   refute multi_internship_agreement.valid?
  ...
  #   short = build(:multi_internship_agreement, student_full_name: 'abcd', enforce_school_manager_validations: true)
  #   long = build(:multi_internship_agreement, student_full_name: 'a' * 101, enforce_school_manager_validations: true)
  #   refute short.valid?
  #   refute long.valid?
  ...
  #   multi_internship_agreement = build(:multi_internship_agreement, student_legal_representative_phone: '1' * 41)
  #   refute multi_internship_agreement.valid?
