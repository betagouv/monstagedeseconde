...
class SyncInternshipOfferKeywordsJobTest < ActiveJob::TestCase
  ...
  test 'insert all keywords' do
    create(:weekly_internship_offer, title: 'hello', description_rich_text: 'boom', employer_description: 'bim')
  ...
  test 'upsert new keyword works' do
    create(:weekly_internship_offer, title: 'hello', description_rich_text: 'boom', employer_description: 'bim')
    SyncInternshipOfferKeywordsJob.perform_now
    create(:weekly_internship_offer, title: 'new', description_rich_text: 'boom', employer_description: 'bim')
