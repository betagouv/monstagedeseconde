...
class SyncInternshipOfferKeywordsJobTest < ActiveJob::TestCase
  ...
  test 'insert all keywords' do
    create(:weekly_internship_offer_2nde, title: 'hello', description: 'boom', employer_description: 'bim')
  ...
  test 'upsert new keyword works' do
    create(:weekly_internship_offer_2nde, title: 'hello', description: 'boom', employer_description: 'bim')
    SyncInternshipOfferKeywordsJob.perform_now
    create(:weekly_internship_offer_2nde, title: 'new', description: 'boom', employer_description: 'bim')
