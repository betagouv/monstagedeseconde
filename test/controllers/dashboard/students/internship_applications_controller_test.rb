...
module Dashboard
  module Students
    class InternshipApplicationsControllerTest < ActionDispatch::IntegrationTest
      ...
      test '#relauch_legal_representative_sign_email sends emails to legal representatives' do
        student = create(:student)
        sign_in(student)
        internship_application = create(:weekly_internship_application, :approved, student:)
        ...
        assert_emails 2 do
          post relauch_legal_representative_sign_email_dashboard_students_internship_application_path(
            student_id: student.id,
      ...
      test '#relauch_legal_representative_sign_email redirects with alert when agreement already signed by legal representative' do
        student = create(:student)
        sign_in(student)
        internship_application = create(:weekly_internship_application, :approved, student:)
        internship_agreement = internship_application.internship_agreement
      ...
      test '#relauch_legal_representative_sign_email redirects with alert when no legal representative email' do
        student = create(:student)
        sign_in(student)
        internship_application = create(:weekly_internship_application, :approved, student:)
        internship_agreement = internship_application.internship_agreement
      ...
      test '#relauch_legal_representative_sign_email is not accessible when not signed in' do
        student = create(:student)
        internship_application = create(:weekly_internship_application, :approved, student:)
        internship_agreement = internship_application.internship_agreement
