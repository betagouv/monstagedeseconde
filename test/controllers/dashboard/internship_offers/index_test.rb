...
module Dashboard::InternshipOffers
  class IndexTest < ActionDispatch::IntegrationTest
    ...
    test "GET #index during seconde_no_new_offers period hides duplicate buttons" do
      travel_to Date.new(2026, 6, 23) do
        employer = create(:employer)
        sign_in(employer)
        create(:weekly_internship_offer_2nde, employer:,
               internship_offer_area_id: employer.current_area_id)
        get dashboard_internship_offers_path
        assert_response :success
    ...
    test "GET #index outside seconde_no_new_offers period shows duplicate buttons" do
      travel_to Date.new(2026, 6, 14) do
        ...
        get dashboard_internship_offers_path
        assert_response :success
        assert_select ".test-duplicate-button"
      end
    end
  end
end
