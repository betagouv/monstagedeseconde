...
module Dashboard::InternshipOffers
  class UpdateTest < ActionDispatch::IntegrationTest
    ...
    test "POST #publish redirects to edit when offer weeks are in the past" do
    ...
    test "PATCH #republish redirects to edit with both warnings when seats are missing and weeks are in the past" do
      travel_to(Date.new(2026, 6, 1)) do
        employer = create(:employer)
        internship_offer = create(:weekly_internship_offer_2nde,
                                  employer:,
