class StudentMailerPreview < ActionMailer::Preview
  ...
  def internship_application_approved_email
    ...
    internship_application.approved_message_tmp = '<strong>Bravo ! Vraiment ! </strong><br/>Vous étiez nombreux à le vouloir, ce stage'
  ...
  def internship_application_rejected_email
    ...
    internship_application.rejected_message_tmp = '<strong>Tellement désolés ! Vraiment ! </strong><br/>Vous trouverez ailleurs tel que vous êtes, ne changez rien'
  ...
  def internship_application_canceled_by_employer_email
    ...
    internship_application.canceled_by_employer_message_tmp = '<strong>Nous ne comprenons pas ce qui s\'est passé ! </strong><br/>L`administration de notre société a décliné votre proposition de stage sans fournir de raison. Une enquête interne est en cours.'
