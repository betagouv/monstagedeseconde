...
def populate_agreements
  ...
  seconde_applications_offers = InternshipApplications::WeeklyFramed.seconde.approved
  agreement_2 = Builders::InternshipAgreementBuilder.new(user: seconde_applications_offers[0].employer)
                                                    .new_from_application(seconde_applications_offers[0])
