def populate_internship_offers
  ...
  InternshipOffers::WeeklyFramed.create!(
    ...
    description_rich_text: 'Vous assistez la responsable de secteur dans la gestion du recrutement des intervenant.e.s à domicile et la gestion des contrats de celles et ceux en contrat avec des particulier-employeurs.',
    employer_description_rich_text: "Du Temps pour moi est une agence mandataire de garde d'enfants à domicile. Notre activité consister à aider les familles de la métropole lilloiseb pour la garde de leurs enfants de 0 à 16 ans.",
    employer_website: 'http://www.dtpm.fr/',
  ...
  InternshipOffers::WeeklyFramed.create!(
    ...
    description_rich_text: 'Vous assistez la responsable de secteur dans la gestion du recrutement des intervenant.e.s à domicile et la gestion des contrats de celles et ceux en contrat avec des particulier-employeurs.',
    employer_description_rich_text: "Du Temps pour moi est une agence mandataire de garde d'enfants à domicile. Notre activité consister à aider les familles pour la garde de leurs enfants de 0 à 16 ans.",
    employer_website: 'http://www.dtpm.fr/',
    street: '128 rue brancion',
    zipcode: '75015',
    city: 'paris',
  ...
  InternshipOffers::WeeklyFramed.create!(
    ...
    description_rich_text: 'Vous assistez au cours de mathématiques de 2de générale du lycée Jean Moulin',
    employer_description_rich_text: "Le métier de professeur de mathématiques consiste à enseigner les mathématiques aux élèves de lycée. Il peut être amené à participer à des projets pédagogiques et à encadrer des élèves.",
    street: '56 rue d\'Entraigues , Tours',
    zipcode: '37000',
    city: 'Tours',
    coordinates: { latitude: Coordinates.tours[:latitude], longitude: Coordinates.tours[:longitude]},
