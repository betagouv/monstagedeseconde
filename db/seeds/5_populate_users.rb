...
def populate_students
  ...
  with_class_name_for_defaults(Users::Student.new(email: 'student_other@ms2e.fr', password: password_value,
                                                  first_name: 'Mohammed', last_name: 'Rivière', school: find_default_school_during_test, class_room: ClassRoom.first, birth_date: 14.years.ago, gender: 'm', confirmed_at: 2.days.ago)).save!
  # sans classe
  with_class_name_for_defaults(Users::Student.new(email: 'enzo@ms2e.fr', password: password_value, first_name: 'Enzo',
                                                  last_name: 'Clerc', school:, birth_date: 14.years.ago, gender: 'm', confirmed_at: 3.days.ago)).save!
  ...
  with_class_name_for_defaults(Users::Student.new(email: 'leon@ms2e.fr', password: password_value, first_name: 'Leon',
                                                  last_name: 'Luanco', school:, birth_date: 14.years.ago, gender: 'm', confirmed_at: 2.days.ago, class_room: class_room_2)).save!
