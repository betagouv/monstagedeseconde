def populate_internship_offers
  ...
  InternshipOffers::WeeklyFramed.create!(
    ...
    sector: Sector.first,
    is_public: false,
    title: '2de - Stage assistant.e ressources humaines - Service des recrutements',
  ...
  InternshipOffers::WeeklyFramed.create!(
    ...
    sector: Sector.first,
    is_public: false,
    title: '3eme - Stage de métrologie - scanner',
  ...
  InternshipOffers::WeeklyFramed.create!(
    ...
    is_public: true,
    title: '2de - Observation du métier de chef de service - Ministère',
  ...
  InternshipOffers::Api.create!(
    ...
    sector: Sector.first,
    is_public: false,
    title: "API - (4e et 3e) Découverte des métiers administratifs de l'Education nationale",
  ...
  InternshipOffers::WeeklyFramed.create!(
    ...
    sector: Sector.first,
    is_public: false,
    title: '2de - Découverte des services douaniers de Valenciennes',
  ...
  InternshipOffers::WeeklyFramed.create!(
    ...
    sector: Sector.first,
    is_public: false,
    title: '3eme - Découverte du travail de gestionnaire en ligne',
    description: description,
  ...
  InternshipOffers::WeeklyFramed.create!(
    ...
    is_public: false,
    school_year: 2024,
    title: '3eme - Découverte du travail de trader',
    description: description,
  ...
  InternshipOffers::Api.create!(
    ...
    sector: Sector.first,
    is_public: false,
    title: "API - 3eme - Découverte des métiers administratifs de l'Education nationale",
    description: "La Direction des Services de l'Education Nationale de Seine-et-Marne (DSDEN) se compose de plusieurs services répartis sur 11 étages. Ses 240 agents  ...",
    employer_description: "Le centre de service IBM de Lille délivre des services d'infrastructure informatique.",
    street: '128 rue brancion',
    zipcode: '75015',
  ...
  InternshipOffers::Api.create!(
    ...
    sector: Sector.first,
    is_public: false,
    title: "API - 4e et 3e - 2024 : Découverte des métiers administratifs de l'Education nationale ",
    description: "La Direction des Services de l'Education Nationale de Seine-et-Marne (DSDEN) se compose de plusieurs services répartis sur 11 étages. Ses 240 agents  ...",
    employer_description: "Le centre de service IBM de Lille délivre des services d'infrastructure informatique.",
    street: '128 rue brancion',
    zipcode: '75015',
