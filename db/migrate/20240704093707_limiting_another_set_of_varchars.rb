class LimitingAnotherSetOfVarchars < ActiveRecord::Migration[7.1]
  def up
...
# employer_name character varying(180),
    ...
    change_column :internship_agreements, :organisation_representative_full_name, :string, limit: 140
    ...
    change_column :identities, :token, :string, limit: 50
    ...
    # class_rooms (
    # name character varying,
    change_column :class_rooms, :name, :string, limit: 50
    ...
    change_column :task_registers, :task_name, :string, limit: 250
    change_column :task_registers, :used_environment, :string, limit: 150
