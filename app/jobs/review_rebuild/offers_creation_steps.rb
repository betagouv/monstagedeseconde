  ...
  module OffersCreationSteps
    ...
    def create_offers
      data_array = [ { # 1 Tours - 2,3
        ...
        sector: care_sector,
        is_public: false,
        title: "(3ème) Stage assistant.e ressources humaines - Service des recrutements",
      ...
      data_array << ({ # 2 Paris - 2,3
        ...
        is_public: false,
        title: "(2nde) Stage de métrologie - scanner",
