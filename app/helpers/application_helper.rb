...
module ApplicationHelper
  ...
  def page_title
    if content_for?(:page_title)
      ...
      default = "Stages à l'école"
      i18n_key = "#{controller_path.tr('/', '.')}.#{action_name}.page_title"
      dyn_page_name = t(i18n_key, default:)
  ...
  #   you'll have to use *webpack_asset_urls helper in your views to get the correct path to the
  #   compiled asset.
  ...
  def compiled_image(asset_name, asset_type)
    # webpack_manifest['images']['assets']['js'][asset_name]
    webpack_manifest['static'][asset_name.concat(asset_type)]
  end
end
