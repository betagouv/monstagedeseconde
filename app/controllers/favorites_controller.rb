...
class FavoritesController < ApplicationController
  ...
  before_action :set_internship_offer, only: %i[create destroy]
  ...
  def format_internship_offer(internship_offer)
    {
      ...
      image: ActionController::Base.helpers.vite_asset_path("media/images/sectors/#{internship_offer.sector.cover}"),
