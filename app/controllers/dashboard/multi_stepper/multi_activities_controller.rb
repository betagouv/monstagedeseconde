  ...
  class MultiActivitiesController < ApplicationController
    ...
    def create
      ...
      if @multi_activity.save
        redirect_to new_dashboard_multi_stepper_multi_coordinator_path(multi_activity_id: @multi_activity.id,
                                                         submit_button: true),
    ...
    def update
      ...
      if @multi_activity.update(multi_activity_params)
        redirect_to new_dashboard_multi_stepper_multi_activity_path(id: @multi_activity.id)
      else
        log_error(object: @multi_activity)
        render :new, status: :bad_request
      end
